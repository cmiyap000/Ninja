...
public class PlayScreen implements Screen {
   ...
   // private Texture background;
    ...
    private TextureRegion[] blockImages;

    //points to a block texture
    private TextureRegion blockPointer;
    ...
    public PlayScreen (BushidoBlocks game) {
       ...
       // stage = new Stage(480, 800, false);
        ...
        blockImages = new TextureRegion[] {
            new TextureRegion(Assets.gris),
            new TextureRegion(Assets.rojo),
            new TextureRegion(Assets.amarillo),
            new TextureRegion(Assets.morado),
            new TextureRegion(Assets.azul),
            new TextureRegion(Assets.horizontal),
            new TextureRegion(Assets.vertical),
            new TextureRegion(Assets.ways)
        };
        ...
        this.game.reqHandler.showBanner();
    ...
    public void render (float delta) {
           ...
           if (timer.getTimeRemaining() <= 0) {
               ...
               game.gameHandler.submitScore(points);
               game.reqHandler.hideBanner();
        ...
        //   font.draw(batch, "time", 60, (800 - 100));
           batch.draw(Assets.time, 50, 650);
           font.draw(batch, String.valueOf(timer.getTimeRemainingInSeconds()), 80, (800 - 150));

           //display score
         //  font.draw(batch, "score", (480 - 180), (800 - 100));
           batch.draw(Assets.score, 250, 650);
           font.draw(batch, String.valueOf(points), (480 - 170), (800 - 150));
    ...
    public void dispose () {
       // background.dispose();
        ...
        for (TextureRegion blockImage : blockImages) {
           // blockImage.dispose();
        }
